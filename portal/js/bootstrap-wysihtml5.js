!function($, wysi) {
    ...
    var tpl = {
        ...
        "justify": function(locale, options) {
            ...
            return "<li>" +
                    "<div class='btn-group'>" +
                    "<a class='btn" + size + "' data-wysihtml5-command='justifyLeft' title='" + locale.justify.left + "'><i class='icon-align-left'></i></a>" +
                    "<a class='btn" + size + "' data-wysihtml5-command='justifyCenter' title='" + locale.justify.center + "'><i class='icon-align-center'></i></a>" +
                    "<a class='btn" + size + "' data-wysihtml5-command='justifyRight' title='" + locale.justify.right + "'><i class='icon-align-right'></i></a>" +
                    "</div>" +
                    "</li>";
        },
    ...
    var defaultOptions = $.fn.wysihtml5.defaultOptions = {
        ...
        stylesheets: ["css/wysiwyg-color.css", "css/wysiwyg-justify.css"], // (path_to_project/lib/css/wysiwyg-color.css)
        locale: "en"
    };
